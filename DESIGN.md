...
**그런데 변수가 안 달린 곳이 있습니다.** F3 §0 에서 전수 조사했습니다. 아래 「예외 열네 줄」과
...
BlockNote 가 색과 글꼴을 전부 변수로 뺀 것은 아닙니다. 아래 **열네 규칙만** 자손 선택자를 씁니다.
...
「배경」·「글자색」·「폭」만 성격이 다르니 해당 절을 따로 읽으세요. 특히 「폭」은 색도 글꼴도
아닌 **치수**를 얹는 유일한 자리입니다.
