 ...
 *
 * - **정렬은 Notion 에 없는 기능입니다.** BlockNote 가 기본 블록에 얹어 둔 것이라 슬래시
 *   메뉴가 아니라 포맷 툴바에서 바꿉니다
 * - 색은 브릿지가 SEED 팔레트로 넘깁니다. **갈색 · 분홍만 SEED 에 없어 BlockNote 기본색
 *   그대로입니다** — 없는 색을 새로 만들면 그게 곧 시스템 밖의 색입니다 (DESIGN.md §1 · §7)
 * - 인라인 서식은 블록이 아니라 글자에 붙는 것입니다 — `에디터/인라인 서식`
 */
...
/**
 * ### 해 볼 것
 * - **배경색** 을 노랑으로 두고 다크로 뒤집어 봅니다. 라이트 · 다크가 한 벌로 맞습니다
 * - **글자색** 을 갈색 · 분홍으로 바꿔 봅니다. 이 둘만 BlockNote 기본색입니다
 * - 글자를 끌어 포맷 툴바로 바꿔 봅니다. 그 결과는 컨트롤에 안 비칩니다
