 ...
 * | 기타 | 이모지 |
 *
 * - **제목4 · 5 · 6 은 없습니다.** 스키마가 `levels: [1, 2, 3]` 으로 닫아서 메뉴에서도
 *   같이 빠집니다 — 슬래시 메뉴가 `propSchema.level.values` 를 훑어 항목을 만듭니다
 * - **목차만 우리 항목입니다** (`slash-menu-items.tsx`). 나머지 20개는 `ko` 사전에서
 *   이름 · 설명 · 별칭 · 그룹이 전부 나옵니다
 *
 ...
 *   콜아웃 · 북마크 · 임베드 · 수식(`knocspace-parity.md`). 목차는 F3 §3 에서 만들었습니다
