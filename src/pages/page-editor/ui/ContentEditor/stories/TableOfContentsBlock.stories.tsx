 ...
 * | 들여쓰기 | 층마다 24px. 층은 **제목 크기가 아니라 앞 제목과의 관계**로 셉니다 |
 * | 층 세는 법 | 제목1 · 3 · 2 · 3 · 1 이면 0 · 1 · 1 · 2 · 0 — 건너뛴 크기는 층을 안 만듭니다 |
 * | 빼는 것 | 글자가 빈 제목 — 누를 수는 있는데 아무것도 안 적힌 줄이 됩니다 |
 * | 찾는 범위 | 접을 수 있는 목록 · 표 안까지 (children 을 따라 내려갑니다) |
 * | 긴 제목 | 한 줄로 자릅니다. 접히면 층이 안 보입니다 |
 * | 글자 | 본문(16px)이 아니라 14px · `fg-neutral-muted`. hover 에서 진해집니다 |
 * | 항목 모양 | 밑줄을 처음부터 긋습니다 — hover 에만 두면 누를 수 있다는 것이 안 보입니다 |
